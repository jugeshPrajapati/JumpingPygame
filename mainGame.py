...
class Game():
    def __init__(self):
        ...
        self.bg = py.image.load(path.join(self.dir, FRAME_PATH, "sky.jpg")).convert()
        self.bg1=py.image.load(path.join(self.dir, FRAME_PATH,'brandon-morgan-3qucB7U2l7I-unsplash.jpg')).convert()
        self.bg2=py.image.load(path.join(self.dir, FRAME_PATH,'night_sky.jpg')).convert()
        self.bg3=py.image.load(path.join(self.dir, FRAME_PATH,'night_sky_7.jpg')).convert()
        self.bg4=py.image.load(path.join(self.dir, FRAME_PATH,'david-moum-nbqlWhOVu6k-unsplash.jpg')).convert()
        ...
        if self.player.vel.y > 0 :
            ...
            if self.hits:
                ...
                if self.player.pos.y < self.lowest.rect.centery and not self.hi:
                    ...
                    o = py.mixer.Sound(path.join(self.dir, MUSIC_PATH, "jumpsound.wav"))
                    o.play()
                    self.player.vel.y=0
        ...
        for event in py.event.get():
            ...
            if event.type == py.KEYDOWN:
                ...
                if event.key == py.K_UP:
                    #self.jump()
                    o=pygame.mixer.Sound(path.join(self.dir, MUSIC_PATH, 'Explosion+1.wav'))
                    o.play()
